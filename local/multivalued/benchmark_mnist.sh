...
#python /users/k1804053/snn/multivalued_snn/wta_exp.py --where=distant --dataset=dvs_gesture_20ms --mode=train_ml_online --num_samples=90000 --n_h=256 --suffix=_4_labels_3 \
#--labels 0 1 3 7
