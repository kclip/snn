...
python /users/k1804053/snn_private/launch_experiment.py --where=rosalind --dataset=mnist_dvs_10_binary --n_h=128 --n_output_enc=64 --num_samples_train=100000 --test_period=5000 --num_ite=1 --suffix=_sytematic_snr_5 \
