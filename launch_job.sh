...
--model=wispike --systematic=false --snr=0 --r=0.3 --labels 1 7 --start_idx=16000 \
--save_path=/users/k1804053/results/027__15-07-2020_mnist_dvs_10_binary_wispike_30000_epochs_nh_676_nout_676_snr_0/
