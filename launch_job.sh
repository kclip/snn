...
python /users/k1804053/snn_private/launch_experiment.py --where=rosalind --dataset=mnist_dvs_10_binary --n_h=256 --n_output_enc=256 --num_samples_train=100000 \
--test_period=5000 --num_ite=1 --suffix=_snr_5_lr_0_0001 --lr=0.0001 \
--model=wispike --systematic=false --snr=5 --r=0.3
